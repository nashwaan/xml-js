...
function validateOptions(userOptions) {
  ...
  helper.ensureFlagExists("indentAttributesCloseSingleLine", options);
...
function writeAttributes(attributes, options, depth) {
  ...
  for (key in attributes) {
    if (
      ...
      if (options.indentAttributesMaxSize) {
        if (
          options.spaces &&
          options.indentAttributes &&
          options.indentAttributesMaxSize &&
          attrLineWidth > options.indentAttributesMaxSize
        ) {
  ...
  if (
    ...
    if (
      options.indentAttributesMaxSize &&
      options.indentAttributesCloseSingleLine &&
      !wrapped
    ) {
      result.push(" ");
    } else {
